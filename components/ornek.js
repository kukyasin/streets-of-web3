...
const streetsofAddress = "0xF60b551AfB306750046bB047D0aC5fe5CB372cF1";
...
const Header = ({ accounts, setAccounts }) => {
  ...
  async function handleMint() {
    ...
    return (
      <div>
        <h1 className="text-white">Streetsof</h1>
        <p className="text-white">Test</p>
        {isConnected ? (
          <div>
            <button type="button" onClick={handleMint}>Mint Now</button>
          </div>
        ) : (
